...
@section('admin_content')
    ...
    <div class="container">
        <h2 class="text-center">คำร้องขออนุญาตทำการโฆษณาโดยใช้เครื่องขยายเสียง <br>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer d-flex justify-content-between">
                            ...
                            <form action="{{ route('AmplifierUpdateStatus', $form->id) }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-primary btn-sm"
                                    @if ($form->form_status == 2) disabled @endif>
                                    กดรับแบบฟอร์ม
                                </button>
                            </form>
                        </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('AmplifierAdminReply', $form->id) }}" method="POST">
                                @csrf
                                <div class="mb-3">
