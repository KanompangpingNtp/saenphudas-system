        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <a href="{{ route('GeneralRoadRequestAdminExportPDF', $form->id) }}" class="btn btn-danger btn-sm" target="_blank">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <form action="{{ route('GeneralRoadRequestUpdateStatus', $form->id) }}" method="POST">
                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('GeneralRoadRequestAdminReply', $form->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
