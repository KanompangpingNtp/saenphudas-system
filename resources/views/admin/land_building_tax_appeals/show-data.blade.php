...
<link rel="stylesheet" href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css">
    ...
    <div class="container">
        <h2 class="text-center">คำร้องคัดค้านการประเมินภาษีหรือ การเรียกเก็บภาษีที่ดินและสิ่งปลูกสร้าง<br>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <a href="{{ route('LandBuildingTaxAppealAdminExportPDF', $form->id) }}" class="btn btn-danger btn-sm" target="_blank">
                        ...
                        <div class="modal-footer d-flex justify-content-between">
                            ...
                            <form action="{{ route('LandBuildingTaxAppealUpdateStatus', $form->id) }}" method="POST">
                            @csrf
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('LandBuildingTaxAppealAdminReply', $form->id) }}" method="POST">
                                @csrf
                                <div class="mb-3">
