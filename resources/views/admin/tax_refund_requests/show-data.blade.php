...
<link rel="stylesheet" href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css">
    ...
    <div class="container">
        <h2 class="text-center">คำร้องขอรับเงินภาษีที่ดินและสิ่งปลูกสร้างคืน<br>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <a href="{{ route('LandTaxRefundRequestAdminExportPDF', $form->id) }}" class="btn btn-danger btn-sm" target="_blank">
                        ...
                        <div class="modal-footer d-flex justify-content-between">
                            ...
                            <form action="{{ route('LandTaxRefundRequestUpdateStatus', $form->id) }}" method="POST">
                            @csrf
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('LandTaxRefundRequestAdminReply', $form->id) }}" method="POST">
                                @csrf
                                <div class="mb-3">
