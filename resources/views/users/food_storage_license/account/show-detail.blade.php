                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($form['details']->status == 10)
                                <a href="{{ route('CertificateFoodStorageLicensePDF', $form->id) }}"
                        ...
                        <td>
                            ...
                            @if ($form['details']->status == 4)
                                <a href="{{ route('FoodStorageLicenseCalendar', $form->id) }}"
                                    class="btn btn-primary btn-sm">
                                    <i class="bi bi-calendar-check"></i>
                                </a>
                            @endif
                            @if ($form['details']->status == 7)
                                <a href="{{ route('FoodStorageLicensePayment', $form->id) }}"
                                    class="btn btn-primary btn-sm">
                                    <i class="bi bi-card-checklist"></i>
                                </a>
                            @endif
                            @if ($form['details'] && $form['details']->status > 6)
                                <a href="{{ route('FoodStorageLicenseUserChecklistPDF', $form->id) }}"
                                    class="btn btn-warning btn-sm" target="_blank">
                                    <i class="bi bi-bookmark-check"></i>
                                </a>
                            @endif
                            <a href="{{ route('FoodStorageLicenseUserExportPDF', $form->id) }}"
