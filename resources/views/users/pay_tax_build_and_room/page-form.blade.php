...
@section('pages_content')
    <div class="container">
        <div class="mt-2 mb-3">
            <img src="{{ asset('eservice/10.png') }}" alt="" style="width: 100%; height: 600px;">
        </div>
        ...
        <form action="{{ route('PayTaxBuildAndRoomFormCreate') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-3">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="title_name" id="person_individual"
                            value="บุคคลธรรมดา" required checked>
            ...
            <div class="row g-3 mb-3" id="personal_div">
                ...
                <div class="col-md-6">
                    <label for="personal_full_name" class="form-label">ชื่อ - นามสกุล <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control require" id="personal_full_name" name="personal_full_name"
                        required>
                </div>
                ...
                <div class="col-md-3">
                    <label for="personal_id_card_number" class="form-label">เลขบัตรประชาชน <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control require" id="personal_id_card_number"
                        name="personal_id_card_number" required maxlength="13">
                </div>

                <div class="col-md-3">
                    <label for="personal_id_card_by" class="form-label">ออกให้โดย <span class="text-danger">*</span></label>
                    <input type="text" class="form-control require" id="personal_id_card_by" name="personal_id_card_by"
                        required>
                </div>

                <div class="col-md-3">
                    <label for="personal_id_card_date" class="form-label">หมดอายุวันที่ <span
                            class="text-danger">*</span></label>
                    <input type="date" class="form-control require" id="personal_id_card_date"
                        name="personal_id_card_date" required>
                </div>

                <div class="col-md-3"></div>

                <div class="col-md-3">
                    <label for="personal_address" class="form-label">อยู่บ้านเลขที่ <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control require" id="personal_address" name="personal_address"
                        required>
                </div>

                <div class="col-md-3">
                    <label for="personal_village" class="form-label">หมู่ที่ </label>
                    <input type="text" class="form-control require" id="personal_village" name="personal_village"
                        required>
                </div>
                ...
                <div class="col-md-3">
                    <label for="personal_subdistrict" class="form-label">แขวง/ตำบล <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control require" id="personal_subdistrict"
                        name="personal_subdistrict" required>
                </div>

                <div class="col-md-3">
                    <label for="personal_district" class="form-label">เขต/อำเภอ <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control require" id="personal_district" name="personal_district"
                        required>
                </div>

                <div class="col-md-3">
                    <label for="personal_province" class="form-label">จังหวัด <span class="text-danger">*</span></label>
                    <input type="text" class="form-control require" id="personal_province" name="personal_province"
                        required>
                </div>

                <div class="col-md-3">
                    <label for="personal_telephone" class="form-label">โทรศัพท์ <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control require" id="personal_telephone" name="personal_telephone"
            ...
            <div class="row g-3 mb-3" id="org_div" style="display:none;">
                ...
                <div class="col-md-6">
                    <label for="org_full_name" class="form-label">ชื่อสถานประกอบการ <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control require" id="org_full_name" name="org_full_name">
                </div>

                <div class="col-md-3">
                    <label for="org_address" class="form-label">สำนักงานใหญ่เลขที่ <span
                            class="text-danger">*</span></label>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control require" id="org_telephone" name="org_telephone"
                        maxlength="10">
                </div>
                ...
                <div class="col-md-6">
                    <label for="org_full_name_2" class="form-label">ชื่อ - นามสกุล <span
                            class="text-danger">*</span></label>
                ...
                <div class="col-md-3">
                    <label for="org_id_card_2" class="form-label">บัตรประจำตัวประชาชนเลขที่ <span
                            class="text-danger">*</span></label>
                ...
                <div class="col-md-3">
                    <label for="org_id_card_date_2" class="form-label">หมดอายุวันที่ <span
                            class="text-danger">*</span></label>
                    <input type="date" class="form-control require" id="org_id_card_date_2"
                        name="org_id_card_date_2">
                </div>
                ...
                <div class="col-md-9">
                    <label for="org_certificate" class="form-label">มีอำนาจลงนามผูกพันนิติบุคคล
                        ตามหนังสือรับรองของสำนักงานทะเบียนหุ้นส่วนบริษัท <span class="text-danger">*</span></label>
                    <input type="text" class="form-control require" id="org_certificate" name="org_certificate">
                </div>

                <div class="col-md-3">
                    <label for="org_certificate_date" class="form-label">ลงวันที่ <span
                            class="text-danger">*</span></label>
                    <input type="date" class="form-control require" id="org_certificate_date"
                        name="org_certificate_date">
                </div>
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-3">
                    <label for="year" class="form-label">ประจำปีภาษี (ภ.ด.ส.๖) <span
                            class="text-danger">*</span></label>
            ...
            <hr>
            <h5>3. ค่าภาษีที่ดินและสิ่งปลูกสร้าง/ห้องชุด ตามข้อ 2.
                ข้าพเจ้าไม่สามารถชำระให้เสร็จสิ้นในคราวเดียวกันได้จึงขอผ่อนชำระเป็นจำนวน 3 งวด ๆ ละเท่า ๆ กัน ภายในกำหนดเวลา
                หากมีเศษเหลือเท่าใดใช้ชำระในงวดที่ 1 ดังนี้</h5><br>
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    <label for="round_date_1" class="form-label">งวดที่ 1 ชำระภายในวันที่ <span
                            class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    <label for="round_date_2" class="form-label">งวดที่ 2 ชำระภายในวันที่ <span
                            class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    <label for="round_date_3" class="form-label">งวดที่ 3 ชำระภายในวันที่ <span
                            class="text-danger">*</span></label>
            ...
            <hr>
            <h5>4. ข้าพเจ้ายอมรับและตกลงว่า ถ้าข้าพเจ้าผิดนัดชำระงวดหนึ่งงวดใด ถือว่าหมดสิทธิที่จะผ่อนชำระ
                และต้องเสียเงินเพิ่มอีกร้อยละหนึ่งต่อเดือนของจำนวนภาษีที่ค้างชำระ เศษของเดือนให้นับเป็นหนึ่งเดือน ตามมาตรา
                ๕๒ แห่งพระราชบัญญัติภาษีที่ดินและสิ่งปลูกสร้าง พ.ศ.๒๕๖๒</h5><br>
            <div class="row g-3 mb-3">
                <div class="col-md-3">
                    <div class="form-check form-check-inline">
            ...
            <div class="mb-3 col-md-12">
                ...
                <div class="form-check">
                    <label class="form-check-label">- แนบสำเนาหนังสือรับรอง สำเนาบัตรประจำตัวประชาชน และหนังสือมอบอำนาจ
                        ถ้ามี(กรณีเป็นนิติบุคคล)</label>
                </div>
            </div>
            <div class="mb-3">
