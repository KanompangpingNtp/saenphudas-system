...
@endif --}}
    <div class="container">
        <div class="mt-2 mb-3">
            <img src="{{ asset('eservice/7.png') }}" alt="" style="width: 100%; height: 600px;">
        </div>
    </div>
    ...
    <form action="{{ route('ChildApplyFormCreate') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="container">
            ...
            <h3 class="text-center">ศูนย์พัฒนาเด็กเล็ก สังกัดเทศบาลตำบลแสนภูดาษ </h3>
            <h4 class="text-center"><span class="text-danger">** </span><strong>หากไม่มีการกรอกข้อมูล กรุณาใส่เครื่องหมาย -
                    แทน</strong></h4><br>
            ...
            <div class="row">
                ...
                <div class="row mb-3">
                    <div class="col-12 col-md-4">
                        ...
                        <input type="number" id="day" name="day" class="form-control" min="1"
                            max="31" required>
                        <small id="dayError" class="form-text text-danger"
                            style="display: none;">กรุณากรอกวันเป็นตัวเลขระหว่าง 1 - 31</small>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <small id="yearError" class="form-text text-danger" style="display: none;">กรุณากรอกปี 4
                            หลัก</small>
                    </div>
                    ...
                    document.querySelectorAll("#day, #month, #year").forEach(input => {
                        input.addEventListener("input", function() {
                            ...
                            if (day && month && year) {
                                ...
                                const formattedDate =
                                    `${String(day).padStart(2, '0')}/${String(month).padStart(2, '0')}/${yearAD}`;
                ...
                <input type="number" class="form-control" name="age_months" id="age_months" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        ?>
                        <input type="hidden" class="form-control" name="age_since_date" id="age_since_date"
                            value="<?= $currentDate ?>" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="citizen_id" class="form-label">เลขประจำตัวประชาชน <span
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label for="regis_house_number" class="form-label">บ้านเลขที่ <span
                                class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label for="current_house_number" class="form-label">บ้านเลขที่ <span
                                class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label for="current_subdistrict" class="form-label">ตำบล <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="current_province" class="form-label">จังหวัด <span
                                class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="current_phone_number" class="form-label">เบอร์โทรศัพท์ <span
                                class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="number_of_siblings" class="form-label">มีพี่น้องร่วมบิดา - มารดาเดียวกันจำนวน
                            (ถ้าไม่มีใส่ - )</label>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="care_option_relative" name="care_option"
                                value="relative" required>
                        ...
                        <div class="col-md-4 mb-3" id="care_option_relativeDiv" style="display: none;">
                            ...
                            <input type="text" id="care_option_relative_text" class="form-control"
                                name="care_option_relative_text">
                        </div>
                        ...
                        <div class="col-md-4 mb-3" id="otherCareOptionDiv" style="display: none;">
                            ...
                            <input type="text" id="care_option_other_text" class="form-control"
                                name="care_option_other_text">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="applicants_name" class="form-label">ผู้นำเด็กมาสมัคร ชื่อ-สกุล <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="applicants_name" name="applicants_name" required>
                    </div>
                    <div class="mb-3 col-md-3">
                        <label for="applicants_relevant" class="form-label">เกี่ยวข้องเป็น <span
                                class="text-danger">*</span></label>
                        <div style="display: flex; align-items: center;">
                            <input type="text" class="form-control" id="applicants_relevant"
                                name="applicants_relevant" style="flex: 1; margin-right: 5px;" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="child_carrier_name" class="form-label">ผู้ที่จะรับส่งเด็กชื่อ - สกุล <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="child_carrier_name" name="child_carrier_name"
                            required>
                    </div>
                    <div class="col-md-6">
                        <label for="child_carrier_relevant" class="form-label">โดยเกี่ยวข้องเป็น <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="child_carrier_relevant"
                            name="child_carrier_relevant" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label for="child_carrier_phone" class="form-label">เบอร์โทรศัพท์ติดต่อ <span
                                class="text-danger">*</span></label>
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <span class="ms-4">1. ข้าพเจ้าขอรับรองว่า
                        ได้อ่านประกาศรับสมัครศูนย์พัฒนาเด็กเล็กสังกัดเทศบาลตำบลแสนภูดาษ เข้าใจแล้ว
                        เด็กที่นำมาสมัครมีคุณสมบัติถูกต้องตรงประกาศ และหลักฐานที่ใช้สมัครใน
                        วันนี้เป็นหลักฐานที่ถูกต้องจริง <br>
                    </span>
                    <span class="ms-4">2.
                        ข้าพเจ้ามีสิทธิถูกต้องในการที่จะให้เด็กสมัครเข้ารับการศึกษาเลี้ยงดูในศูนย์พัฒนาเด็กเล็กสังกัดเทศบาลตำบลแสนภูดาษ
                        <br></span>
                    <span class="ms-4">3. ข้าพเจ้ายินดีปฏิบัติตามระเบียบ ข้อกำหนดเทศบาลตำบลแสนภูดาษ
                        และยินดีปฏิบัติตามคำแนะนำเกี่ยวกับการพัฒนาความพร้อมที่ศูนย์พัฒนาเด็กเล็ก กำหนด</span>
                    <br>
                    <br>
                    {{-- <span><strong>หมายเหตุ</strong> เอาข้อมูลเอกสาร/หลักฐานที่ใช้ในการสมัครเรียน ให้นำมาพร้อมนักเรียน ติดต่อมอบตัว ภายใน 7วัน ทำการที่ศูนย์พัฒนาเด็กเล็กเทศบาลตำบลแสนภูดาษ </span> --}}
                </div>
                ...
                <h3 class="text-center">ศูนย์พัฒนาเด็กเล็กเทศบาลตำบลแสนภูดาษ <br></h3>
                <h4 class="text-center"><span class="text-danger">** </span><strong>หากไม่มีการกรอกข้อมูล
                        กรุณาใส่เครื่องหมาย - แทน</strong></h4><br>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="surrender_full_name" class="form-label">ข้าพเจ้า ชื่อ - สกุล <span
                                class="text-danger">*</span></label>
                        <input type="text" name="surrender_full_name" id="surrender_full_name" class="form-control"
                            required>
                    </div>

                    <div class="col-md-2 mb-3">
                        <label for="surrender_age" class="form-label">อายุ (ปี) <span
                                class="text-danger">*</span></label>
                        <input type="number" name="surrender_age" id="surrender_age" class="form-control" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="surrender_occupation" class="form-label">อาชีพ <span
                                class="text-danger">*</span></label>
                        <input type="text" name="surrender_occupation" id="surrender_occupation" class="form-control"
                            required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="surrender_income" class="form-label">รายได้ <span
                                class="text-danger">*</span></label>
                        <input type="text" name="surrender_income" id="surrender_income" class="form-control"
                            required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="surrender_hour_number" class="form-label">ที่อยู่ปัจจุบัน เลขที่ <span
                                class="text-danger">*</span></label>
                        <input type="text" name="surrender_hour_number" id="surrender_hour_number"
                            class="form-control" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="surrender_village" class="form-label">หมู่ <span class="text-danger">*</span></label>
                        <input type="text" name="surrender_village" id="surrender_village" class="form-control"
                            required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="surrender_alley_road" class="form-label">ซอย <span
                                class="text-danger">*</span></label>
                        <input type="text" name="surrender_alley_road" id="surrender_alley_road" class="form-control"
                            required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="surrender_subdistrict" class="form-label">ตำบล <span
                                class="text-danger">*</span></label>
                        <input type="text" name="surrender_subdistrict" id="surrender_subdistrict"
                            class="form-control" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="surrender_district" class="form-label">อำเภอ <span
                                class="text-danger">*</span></label>
                        <input type="text" name="surrender_district" id="surrender_district" class="form-control"
                            required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="surrender_province" class="form-label">จังหวัด <span
                                class="text-danger">*</span></label>
                        <input type="text" name="surrender_province" id="surrender_province" class="form-control"
                            required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="surrender_phone_number" class="form-label">โทรศัพท์ <span
                                class="text-danger">*</span></label>
                        <input type="text" name="surrender_phone_number" id="surrender_phone_number"
                            class="form-control" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <label for="child_surrender_salutation1" class="form-label mb-0">คำนำหน้า <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4" style="display: inline-block;">
                        ...
                        <input type="text" name="surrender_childs_name" id="surrender_childs_name"
                            class="form-control" required>
                    </div>
                </div>
                <div style="margin-top: 20px;">
                    <span>เข้าเป็นนักเรียนของศูนย์ พัฒนาเด็กเล็กเทศบาลตำบลแสนภูดาษ
                        และพร้อมที่จะปฏิบัติตามระเบียบการของศูนย์พัฒนาเด็กเล็กเทศบาลตำบลแสนภูดาษ ดังนี้</span><br>
                    <span class="ms-5"> 1. จะปฏิบัติตามระเบียบ ข้อบังคับของศูนย์พัฒนาเด็กเล็กเทศบาลตำบลแสนภูดาษ
                        อย่างเคร่งครัด</span><br>
                    <span class="ms-5"> 2. จะร่วมมือกับศูนย์พัฒนาเด็กเล็กเทศบาลตำบลแสนภูดาษ
                        ในการจัดการเรียนการสอนและขจัดปัญหาต่างๆ ที่อาจเกิดขึ้นแก่เด็กอย่างใกล้ชิด
                    </span>
                </div>
                <div class="row">
                    <div class="col-md-4 mb-3" style="margin-top: 10px;">
                        <label for="surrender_contact_location"
                            class="form-label">สถานที่ที่สามารถติดต่อกับผู้ปกครองได้สะดวกรวดเร็วที่สุด</label>
                        <input type="text" name="surrender_contact_location" id="surrender_contact_location"
                            class="form-control">
                    </div>

                    <div class="col-md-4 mb-3" style="margin-top: 10px;">
                        <label for="surrender_contact_phone" class="form-label">โทรศัพท์</label>
                        <input type="text" name="surrender_contact_phone" id="surrender_contact_phone"
                            class="form-control">
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center gap-2">
                    <span>อนึ่ง</span>
                    <div class="col-md-2">
                        <label for="child_recipient_salutation" class="form-label mb-0">คำนำหน้า <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        <label for="surrender_child_recipient" class="form-label mb-0">ชื่อ-นามสกุล เด็ก <span
                                class="text-danger">*</span></label>
                        <input type="text" name="surrender_child_recipient" id="surrender_child_recipient"
                            class="form-control" required>
                    </div>

                    <span class="mt-4">เจ็บป่วย จำเป็นต้องรีบส่งโรงพยาบาลหรือพบแพทย์ทันที
                        ข้าพเจ้าอนุญาติให้ศูนย์พัฒนาเด็กเล็ก</span>
                </div>
                <span style="margin-top: 15px;">จัดการไปตามความเห็นชอบก่อน และแจ้งให้ข้าพเจ้าทราบ
                    โดยข้าพเจ้าขอรับผิดชอบค่าใช้จ่ายที่เกิดขึ้น</span>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="child_recipient_relevant" id="child_recipient_relevant"
                        class="form-control">
                </div>

                <div class="col-md-4 mb-3">
                    <label for="child_recipient_related" class="form-label">โดยเกี่ยวข้องเป็น</label>
                    <input type="text" name="child_recipient_related" id="child_recipient_related"
                        class="form-control">
                </div>
