...
<form action="{{ route('ChildApplyFormCreate') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="container">
        ...
        <div class="col-md-12 mb-4">
            ...
            <span class="ms-4">1. ข้าพเจ้าขอรับรองว่า ได้อ่านประกาศรับสมัครศูนย์พัฒนาเด็กเล็กสังกัดเทศบาลตำบลแสนภูดาษ เข้าใจแล้ว เด็กที่นำมาสมัครมีคุณสมบัติถูกต้องตรงประกาศ และหลักฐานที่ใช้สมัครใน
                 วันนี้เป็นหลักฐานที่ถูกต้องจริง <br>
            </span>
            <span class="ms-4">2. ข้าพเจ้ามีสิทธิถูกต้องในการที่จะให้เด็กสมัครเข้ารับการศึกษาเลี้ยงดูในศูนย์พัฒนาเด็กเล็กสังกัดเทศบาลตำบลแสนภูดาษ  <br></span>
            <span class="ms-4">3. ข้าพเจ้ายินดีปฏิบัติตามระเบียบ ข้อกำหนดเทศบาลตำบลแสนภูดาษ  และยินดีปฏิบัติตามคำแนะนำเกี่ยวกับการพัฒนาความพร้อมที่ศูนย์พัฒนาเด็กเล็ก กำหนด</span>
            <br>
            <br>
        ...
        <div style="margin-top: 20px;">
            <span>เข้าเป็นนักเรียนของศูนย์ พัฒนาเด็กเล็กเทศบาลตำบลแสนภูดาษ และพร้อมที่จะปฏิบัติตามระเบียบการของศูนย์พัฒนาเด็กเล็กเทศบาลตำบลแสนภูดาษ  ดังนี้</span><br>
            <span class="ms-5"> 1. จะปฏิบัติตามระเบียบ ข้อบังคับของศูนย์พัฒนาเด็กเล็กเทศบาลตำบลแสนภูดาษ  อย่างเคร่งครัด</span><br>
            <span class="ms-5"> 2. จะร่วมมือกับศูนย์พัฒนาเด็กเล็กเทศบาลตำบลแสนภูดาษ  ในการจัดการเรียนการสอนและขจัดปัญหาต่างๆ ที่อาจเกิดขึ้นแก่เด็กอย่างใกล้ชิด
            </span>
        </div>
        <div class="row">
