    ...
    <ul class="menu-inner py-1">
        ...
        @auth
            @if (Auth::user()->is_ong == 1)
                ...
                <li class="menu-item {{ request()->is(patterns: 'admin/GarbageCollection*') ? 'active' : '' }}">
                    <a href="{{ route('GarbageCollectionAdminShowData') }}" class="menu-link">
                        <i class='menu-icon tf-icons bx bx-clipboard-detail'></i>
                        <div data-i18n="Analytics">ข้อมูลฟอร์มที่ส่งเข้ามา</div>
                    </a>
                </li>
